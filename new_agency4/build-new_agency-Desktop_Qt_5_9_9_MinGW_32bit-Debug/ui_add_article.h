...
public:
    ...
    void setupUi(QDialog *add_article)
    {
        ...
        Browseimage = new QPushButton(add_article);
        Browseimage->setObjectName(QStringLiteral("Browseimage"));
        Browseimage->setGeometry(QRect(20, 180, 91, 23));
    ...
    void retranslateUi(QDialog *add_article)
    {
        ...
        Browseimage->setText(QApplication::translate("add_article", "Browse Image", Q_NULLPTR));
    } // retranslateUi
