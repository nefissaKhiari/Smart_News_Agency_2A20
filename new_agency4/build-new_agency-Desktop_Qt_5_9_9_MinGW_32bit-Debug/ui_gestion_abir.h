...
"background-color: rgb(255, 170, 127);"));
        ...
        tabWidget->setStyleSheet(QLatin1String("background-image: url(:/new/prefix1/img/maxresdefault.jpg);\n"
"background-color: rgb(230, 0, 0);"));
        ...
        Imprimer->setGeometry(QRect(250, 460, 221, 41));
        ...
        toolBar->setStyleSheet(QLatin1String("background-image: url(:/new/prefix1/img/maxresdefault.jpg);\n"
"background-color: rgb(230, 0, 0);"));
    ...
    void retranslateUi(QMainWindow *gestion_abir)
    {
        ...
        Imprimer->setText(QApplication::translate("gestion_abir", "Imprimer", Q_NULLPTR));
