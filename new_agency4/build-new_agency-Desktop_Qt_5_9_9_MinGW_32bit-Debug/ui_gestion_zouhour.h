...
public:
    ...
    void setupUi(QMainWindow *gestion_zouhour)
    {
        ...
        gestion_zouhour->setStyleSheet(QStringLiteral("background-image: url(:/new/prefix1/img/maxresdefault.jpg);"));
        ...
        tabWidget->setStyleSheet(QLatin1String("background-image: url(:/new/prefix1/img/hand-painted-watercolor-background-with-sky-clouds-shape_24972-1095.jpg);\n"
...
"background-image: url(:/new/prefix1/img/maxresdefault.jpg);"));
        ...
        verticalSlider->setGeometry(QRect(530, 500, 22, 111));
        verticalSlider->setOrientation(Qt::Vertical);
        playm = new QPushButton(tab_3);
        playm->setObjectName(QStringLiteral("playm"));
        playm->setGeometry(QRect(580, 580, 93, 28));
        pause = new QPushButton(tab_3);
        pause->setObjectName(QStringLiteral("pause"));
        pause->setGeometry(QRect(680, 580, 93, 28));
        pushButton_4 = new QPushButton(tab_3);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(630, 500, 111, 28));
    ...
    void retranslateUi(QMainWindow *gestion_zouhour)
    {
        ...
        playm->setText(QApplication::translate("gestion_zouhour", "play", Q_NULLPTR));
        pause->setText(QApplication::translate("gestion_zouhour", "pause", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("gestion_zouhour", "choisir musique", Q_NULLPTR));
