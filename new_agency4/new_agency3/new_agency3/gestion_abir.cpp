...
{
    Smtp* smtp = new Smtp("projetqtc2021@gmail.com",password, "smtp.gmail.com");
  ...
  //  files=img.split("+");
   if( !files.isEmpty() )
      smtp->sendMail("projetqtc2021@gmail.com", recipient , subject,msg, files);
    else
        smtp->sendMail("projetqtc2021@gmail.com", recipient , subject,msg);
}
...
void gestion_abir::on_Imprimer_clicked()
{
    QString strStream;
