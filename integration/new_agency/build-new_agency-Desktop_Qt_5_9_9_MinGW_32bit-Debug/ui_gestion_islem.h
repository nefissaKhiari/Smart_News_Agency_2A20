...
public:
    ...
    void setupUi(QMainWindow *gestion_islem)
    {
        ...
        gestion_islem->setStyleSheet(QLatin1String("background-color: rgb(255, 170, 127);\n"
...
"background-color: rgb(255, 170, 127);"));
        ...
        toolBar->setStyleSheet(QLatin1String("background-image: url(:/res/img/hand-painted-watercolor-background-with-sky-clouds-shape_24972-1095.jpg);\n"
"background-image: url(:/new/prefix1/img/hand-painted-watercolor-background-with-sky-clouds-shape_24972-1095.jpg);"));
