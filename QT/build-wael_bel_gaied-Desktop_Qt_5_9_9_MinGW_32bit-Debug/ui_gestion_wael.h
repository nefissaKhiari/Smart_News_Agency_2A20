...
public:
    ...
    void retranslateUi(QMainWindow *gestion_wael)
    {
        ...
        label->setText(QApplication::translate("gestion_wael", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#5500ff;\">Gestion Equipements</span></p></body></html>", Q_NULLPTR));
        ...
        label_4->setText(QApplication::translate("gestion_wael", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#5500ff;\">Gestion Zones</span></p></body></html>", Q_NULLPTR));
